...
function buildUserPermissionOverrideRegistry(PDO $pdo): array
{
    ...
    $manual = [
        ...
        'recycle-bin.restore' => ['Restore deleted records', 'Requires Recycle Bin page access and permission to edit the original record type. Includes suppliers and supported drafts. Does not permit permanent deletion.', 'Recycle Bin', ['SuperAdmin']],
