...
$base = [
    ...
    'upload_allowed_types' => array_map('trim', explode(',', $_ENV['UPLOAD_ALLOWED_TYPES'] ?? 'jpg,jpeg,png,webp,jfif,gif,bmp,avif,pdf')),
    'upload_allowed_extensions' => array_map('trim', explode(',', $_ENV['UPLOAD_ALLOWED_TYPES'] ?? 'jpg,jpeg,png,webp,jfif,gif,bmp,avif,pdf')),
