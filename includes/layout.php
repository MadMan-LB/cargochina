...
<body>
  ...
  <aside class="clms-sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <?php else: ?>
        <div class="sidebar-section-label">Container Ops</div>
      <?php endif; ?>
      <?php if ($isBuyer): ?>
      ...
      <?php if ($isAdmin || $isWarehouse): ?>
        <a class="sidebar-link <?= $currentPage === 'expenses' ? 'active' : '' ?>" href="<?= ($isWarehouse && !$isAdmin) ? $basePath . '/warehouse/expenses.php' : $basePath . '/expenses.php' ?>">
          <svg class="sidebar-icon" viewBox="0 0 24 24">
      ...
      <?php if ($isBuyer || $isFieldStaff || $canViewCustomersPage): ?>
