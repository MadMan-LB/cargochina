      ...
      if (b && p) {
        fetch('/cargochina/api/v1/notifications', {
          ...
          .then(r => r.json()).then(d => {
            ...
            var notifUrl = '/cargochina/notifications.php';
            p.innerHTML = unread.length ? unread.slice(0, 5).map(n => '<a class="dropdown-item" href="' + notifUrl + '">' + (n.title || '') + '</a>').join('') : 'No new notifications';
          }).catch(function() {
