...
<div id="receiveForm" class="card mb-3">
    ...
    <div class="card-body">
        <div class="row mb-3">
            <div class="col-md-4"><label class="form-label">Actual Cartons *</label><input type="number"
                    class="form-control" id="actualCartons" min="0" required></div>
            <div class="col-md-4"><label class="form-label">Actual CBM</label><input type="number" step="0.0001"
                    class="form-control" id="actualCbm" min="0" placeholder="Direct or from L×W×H"></div>
            <div class="col-md-4"><label class="form-label">L / W / H (cm)</label>
            ...
            <div class="col-md-4"><label class="form-label">Actual Weight *</label><input type="number" step="0.0001"
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-8"><label class="form-label">Notes</label><input type="text" class="form-control"
                    id="receiveNotes"></div>
        </div>
    </div>
</div>
