    ...
    <div class="card mb-3">
      <div class="card-body py-2">
        <div class="row g-2 align-items-end">
          ...
          <div class="col-auto"><button type="button" class="btn btn-outline-success btn-sm" onclick="exportQueueXlsx()" title="<?= htmlspecialchars(clmsT('Download complete filtered results')) ?>"><?= htmlspecialchars(clmsT('Download')) ?></button></div>
        </div>
      </div>
    </div>
