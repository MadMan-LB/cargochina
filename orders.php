        ...
        <form id="orderForm">
          ...
          <div class="order-form-panel">
            ...
            <div class="d-flex gap-2 mb-2">
              <button type="button" class="btn btn-outline-secondary btn-sm" id="togglePasteCsv" onclick="window.togglePasteCsv()">Paste CSV</button>
            </div>
            <div id="pasteCsvArea" class="mb-3 d-none">
              ...
              <small class="text-muted d-block mt-1">Paste rows from Excel/Sheets. Optional header row. Columns: what_brand, good_type, code, item_no, description, cartons, qty_per_carton, qty, unit_price, weight, cbm, express_number, size. With a header, use I.I.N for the internal identifier and Item Number for the packing-list reference.</small>
