      ...
      <div class="modal-body">
        <form id="productForm" class="product-form-compact">
          ...
          <div class="row g-2">
            ...
            <div class="col-12 col-md-6 mb-1"><label class="form-label form-label-sm" for="productItemType"><?= htmlspecialchars(clmsT('Item type')) ?> *</label><select class="form-select form-select-sm" id="productItemType" required><option value=""><?= htmlspecialchars(clmsT('Choose and confirm')) ?></option><option value="normal"><?= htmlspecialchars(clmsT('Normal goods')) ?></option><option value="replica"><?= htmlspecialchars(clmsT('Copy / replica goods')) ?></option><option value="cosmetics"><?= htmlspecialchars(clmsT('Cosmetics')) ?></option><option value="branded"><?= htmlspecialchars(clmsT('Branded goods')) ?></option><option value="food"><?= htmlspecialchars(clmsT('Food')) ?></option><option value="dangerous"><?= htmlspecialchars(clmsT('Dangerous goods')) ?></option><option value="other"><?= htmlspecialchars(clmsT('Other')) ?></option></select><div class="form-text">Uncertain products cannot be silently saved as normal.</div></div>
