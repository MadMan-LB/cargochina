(() => {
  ...
  async function load() {
    ...
    try {
      ...
      if(res.meta.allowed_types?.length===0)document.getElementById('recycleRows').innerHTML='<tr><td colspan="6">Recycle Bin access is enabled. Access to Suppliers, Draft an Order or shipment drafts is also required to view their deleted records.</td></tr>';
